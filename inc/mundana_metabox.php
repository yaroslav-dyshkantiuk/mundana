...
function mundana_add_metabox() {
    add_meta_box('mundana_metabox-1', __('Post Data', 'mundana'), 'mundana_add_metabox_cb', array('post'));
}
...
function mundana_add_metabox_cb($post) {
    ...
    <table class="form-table">
        <tbody>
            <tr>
                <th><label for="read_minutes"><?php esc_html_e('Number of minutes to read', 'mundana'); ?></label></th>
                <td><input type="number" min="0" id="read_minutes" name="read_minutes" class="regular-text" value="<?php echo $read_minutes; ?>"></td>
            </tr>
            <tr>
                <th><label for="is_featured"><?php esc_html_e('Add to featured posts', 'mundana'); ?></label></th>
                <td><input type="checkbox" min="0" id="is_featured" name="is_featured" class="regular-text" <?php checked('yes', $is_featured); ?>></td>
            </tr>
        </tbody>
    </table>
